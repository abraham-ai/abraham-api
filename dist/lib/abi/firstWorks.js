export const AbrahamFirstWorks = [
    {
        inputs: [
            ...
            { internalType: "address", name: "_authorizedMinter", type: "address" },
    ...
    { inputs: [], name: "EmptyBaseURI", type: "error" },
    { inputs: [], name: "EmptyTokenArray", type: "error" },
    {
        inputs: [
            { internalType: "uint256", name: "requested", type: "uint256" },
    ...
    { inputs: [], name: "InvalidRoyaltyFee", type: "error" },
    { inputs: [], name: "InvalidRoyaltyReceiver", type: "error" },
    {
        inputs: [
            { internalType: "uint256", name: "tokenId", type: "uint256" },
    ...
    },
    {
        inputs: [
            ...
            { internalType: "address", name: "authorizedMinter", type: "address" },
        ],
    ...
    },
    {
        ...
        name: "mintTo",
        outputs: [
            { internalType: "uint256[]", name: "mintedTokenIds", type: "uint256[]" },
        ],
        stateMutability: "nonpayable",
        type: "function",
    },
