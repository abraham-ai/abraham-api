 ...
 */
async function generateMerkle(snapshotPath) {
    console.log("\n" + "=".repeat(60));
 ...
 */
async function updateContract(merkleRoot) {
    console.log("\n" + "=".repeat(60));
 ...
 * Main execution
 */
export async function updateSnapshotAndMerkle(skipContractUpdate = false) {
    const result = {
        success: false,
        steps: {
            snapshot: false,
